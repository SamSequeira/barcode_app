...
$totalEntriesSql = "SELECT COUNT(*) as total_entries FROM users WHERE entry_time IS NOT NULL";
$totalExitsSql = "SELECT COUNT(*) as total_exits FROM users WHERE exit_time IS NOT NULL";
...
$frequentVisitorsSql = "SELECT barcode, COUNT(*) as visits FROM users GROUP BY barcode ORDER BY visits DESC LIMIT 5";
...
$physicalEntriesSql = "SELECT COUNT(*) as count FROM users WHERE login_type = 'Physical' AND entry_time IS NOT NULL";
$digitalEntriesSql = "SELECT COUNT(*) as count FROM users WHERE login_type = 'Digital' AND entry_time IS NOT NULL";
